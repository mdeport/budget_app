...
List<IconData> objectifIcons = [
  ...
  // Catégorie : Sorties au restaurant
  FontAwesomeIcons.utensils,
...
Map<IconData, String> iconNamesobjectif = {
  ...
  FontAwesomeIcons.mobile: 'mobile',
  FontAwesomeIcons.car: 'car',
  FontAwesomeIcons.paw: 'paw',
  FontAwesomeIcons.fileInvoice: 'fileInvoice',
